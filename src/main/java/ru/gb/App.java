...
public class App {
    public static void main(String[] args) {
        ...
        System.out.println("Вывод строк, которые начинаются на <A> -> ");
        IsGood<String> isGoodBeginsWithA = new BeginsWithA();
        System.out.println(filter(checkListStr, isGoodBeginsWithA));

        System.out.println("Вывод строк, которые начинаются на <Ma> -> ");
        IsGood<String> isGoodBegins = new BeginsWith("Ma");
